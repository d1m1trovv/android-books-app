...
public class FantasyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(BookModel book : db.getAllBooks()){
            if(book.get_genre().equals("Фантастика")){
                books.add(book);
            }
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.item1:
                ...
                Intent profileActivity = new Intent(FantasyActivity.this, ProfileActivity.class);
            ...
            case R.id.item3:
                ...
                Intent favoritesActivity = new Intent(FantasyActivity.this, FavoritesActivity.class);
                startActivity(favoritesActivity);
                return true;
            case R.id.subitem0:
                Intent mainActiity = new Intent(FantasyActivity.this, MainActivity.class);
                startActivity(mainActiity);
                Toast.makeText(this, "All books", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.subitem1:
                Intent thrillersActivity = new Intent(FantasyActivity.this, ThrillersActivity.class);
                ...
                return true;
            case R.id.subitem2:
                Intent criminalActivity = new Intent(FantasyActivity.this, CriminalActivity.class);
                startActivity(criminalActivity);
                Toast.makeText(this, "Criminal selected", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.subitem3:
                Intent fantasyActivity = new Intent(FantasyActivity.this, FantasyActivity.class);
    ...
    public class Listener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(FantasyActivity.this, ReadActivity.class);
