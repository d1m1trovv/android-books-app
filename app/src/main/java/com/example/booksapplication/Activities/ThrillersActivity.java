...
public class ThrillersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thrillers);
        DatabaseHandler db = new DatabaseHandler(this);

        ListView listView = (ListView)findViewById(R.id.listView);

        for(BookModel book : db.getAllBooks()){
            if(book.get_genre().equals("Трилър")){
                books.add(book);
            }
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.item1:
                ...
                Intent profileActivity = new Intent(ThrillersActivity.this, ProfileActivity.class);
            ...
            case R.id.item3:
                ...
                Intent favoritesActivity = new Intent(ThrillersActivity.this, FavoritesActivity.class);
                startActivity(favoritesActivity);
                return true;
            case R.id.subitem0:
                Intent mainActiity = new Intent(ThrillersActivity.this, MainActivity.class);
                startActivity(mainActiity);
                Toast.makeText(this, "All books", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.subitem1:
                Intent thrillersActivity = new Intent(ThrillersActivity.this, ThrillersActivity.class);
                ...
                return true;
            case R.id.subitem2:
                Intent criminalActivity = new Intent(ThrillersActivity.this, CriminalActivity.class);
                startActivity(criminalActivity);
                Toast.makeText(this, "Criminal selected", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.subitem3:
                Intent fantasyActivity = new Intent(ThrillersActivity.this, FantasyActivity.class);
    ...
    public class Listener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(ThrillersActivity.this, ReadActivity.class);
